...
/*
 * Function: adf_save_fnc_environment
 ...
 *
 * Examples:
 * [1] call adf_save_fnc_environment
 *
 * Public: Yes
 */
...
[EGVAR(db,debug), "adf_save_fnc_environment", text format ["Saving environment info to slot '%1'.", _slot], false] call DEFUNC(utils,debug);
